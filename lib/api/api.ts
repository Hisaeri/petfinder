...
class Api {
    ...
    private get<T>(url: string, params: unknown | undefined, headers: AxiosRequestHeaders | undefined) {
    ...
    postPetfinderToken() {
        ...
        return this.post<PetfinderToken>("https://api.petfinder.com/v2/oauth2/token", data);
    }
